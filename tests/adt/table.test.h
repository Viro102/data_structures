...
namespace ds::tests {
namespace details {
template <class TableT> class TableTestBase : public LeafTest {
  public:
    TableTestBase(const std::string &name, size_t seed) : LeafTest(name), rngKey_(seed) {}
 ...
 */
template <class TableT> class TableTestInsert : public details::TableTestBase<TableT> {
  public:
    TableTestInsert() : details::TableTestBase<TableT>("insert", 123) {}
 ...
 * @tparam TableT Table type
 */
template <class TableT> class TableTestLookup : public details::TableTestBase<TableT> {
  public:
    TableTestLookup() : details::TableTestBase<TableT>("find-tryFind-contains", 456) {}
 ...
 * @tparam TableT Table type
 */
template <class TableT> class TableTestRemove : public details::TableTestBase<TableT> {
  public:
    TableTestRemove() : details::TableTestBase<TableT>("remove", 789) {}
 ...
 * @tparam TableT Table type
 */
template <class TableT> class TableTestClear : public details::TableTestBase<TableT> {
  public:
    TableTestClear() : details::TableTestBase<TableT>("clear", 147) {}
 ...
 * @tparam TableT Table type
 */
template <class TableT> class TableTestCopyAssign : public details::TableTestBase<TableT> {
  public:
    TableTestCopyAssign() : details::TableTestBase<TableT>("copy-assign", 258) {}
 ...
 * @tparam TableT Table type
 */
template <class TableT> class TableTestIterator : public details::TableTestBase<TableT> {
  public:
    TableTestIterator() : details::TableTestBase<TableT>("iterator", 214) {}
 ...
 * @tparam TableT Table type
 */
template <class TableT> class TableTestEquals : public details::TableTestBase<TableT> {
  public:
    TableTestEquals() : details::TableTestBase<TableT>("equals", 874) {}
 ...
 * @tparam TableT Table type
 */
template <class TableT> class TableTestScenario : public details::TableTestBase<TableT> {
  public:
    TableTestScenario() : details::TableTestBase<TableT>("scenario", 997) {}
 ...
 */
template <class TableT> class GeneralTableTest : public CompositeTest {
  public:
...
class SequenceTableTest : public CompositeTest {
  public:
    SequenceTableTest() : CompositeTest("SequenceTable") {
        this->add_test(
            std::make_unique<GeneralTableTest<adt::UnsortedImplicitSequenceTable<int, int>>>(
                "UnsortedImplicitSequenceTable"));
        this->add_test(
            std::make_unique<GeneralTableTest<adt::UnsortedExplicitSequenceTable<int, int>>>(
                "UnsortedExplicitSequenceTable"));
        this->add_test(std::make_unique<GeneralTableTest<adt::SortedSequenceTable<int, int>>>(
            "SortedSequenceTable"));
    }
};
...
class NonSequenceTableTest : public CompositeTest {
  public:
    NonSequenceTableTest() : CompositeTest("NonSequenceTable") {
        ...
        this->add_test(std::make_unique<GeneralTableTest<adt::BinarySearchTree<int, int>>>(
            "BinarySearchTree"));
