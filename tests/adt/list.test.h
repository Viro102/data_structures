 ...
 */
template <class ListT> class ListTestInsertEnds : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestInsertRandom : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestCalculateIndex : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestAccessEnds : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestAccessRandom : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestSet : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestRemoveEnds : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestRemoveRandom : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestIterators : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestClear : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class ListTestCopyAssignEquals : public LeafTest {
  public:
 ...
 * @tparam ListT Type of the list.
 */
template <class ListT> class GeneralListTest : public CompositeTest {
  public:
...
class ListTest : public CompositeTest {
  public:
    ListTest() : CompositeTest("List") {
        ...
        this->add_test(
            std::make_unique<GeneralListTest<adt::SinglyLinkedList<int>>>("SinglyLinkedList"));
        this->add_test(
            std::make_unique<GeneralListTest<adt::DoublyLinkedList<int>>>("DoublyLinkedList"));
    }
};
} // namespace ds::tests
