...
#include <libs/include/adt/stack.h>
 ...
 */
template <class StackT> class StackTestPushPeek : public LeafTest {
  public:
  ...
  protected:
    void test() override {
        ...
        this->assert_throws([&stack]() { stack.peek(); }, "Empty stack throws on peek");
 ...
 * @tparam StackT Type of the stack.
 */
template <class StackT> class StackTestPop : public LeafTest {
  public:
  ...
  protected:
    void test() override {
        ...
        this->assert_throws([&stack]() { stack.pop(); }, "Empty stack throws on pop");
 ...
 * @tparam StackT Type of the stack.
 */
template <class StackT> class StackTestClear : public LeafTest {
  public:
 ...
 * @tparam StackT Type of the stack.
 */
template <class StackT> class StackTestCopyAssignEquals : public LeafTest {
  public:
 ...
 * @tparam StackT Type of the stack.
 */
template <class StackT> class GeneralStackTest : public CompositeTest {
  public:
...
class StackTest : public CompositeTest {
  public:
    StackTest() : CompositeTest("Stack") {
        this->add_test(
            std::make_unique<GeneralStackTest<adt::ImplicitStack<int>>>("ImplicitStack"));
        this->add_test(
            std::make_unique<GeneralStackTest<adt::ExplicitStack<int>>>("ExplicitStack"));
    }
};
} // namespace ds::tests
