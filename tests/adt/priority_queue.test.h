...
namespace ds::tests {
namespace details {
template <class PrioQueueT> class PrioQueueTestBase : public LeafTest {
  public:
    PrioQueueTestBase(const std::string &name) : LeafTest(name), rngPrio_(144), distPrio_(0, 10) {}

  protected:
    int generateRandomPriority() { return distPrio_(rngPrio_); }
 ...
 * @tparam PrioQueueT Type of the priority queue.
 */
template <class PrioQueueT> class PrioQueueTestPop : public details::PrioQueueTestBase<PrioQueueT> {
  public:
...
class PrioQueueTestCopyAssign : public details::PrioQueueTestBase<PrioQueueT> {
  public:
    PrioQueueTestCopyAssign() : details::PrioQueueTestBase<PrioQueueT>("copy-assign") {}
  ...
  protected:
    void test() override {
        ...
        this->assert_true(this->bruteforceEquals(queue1, queue2),
        ...
        queue1.pop();
        queue1.pop();
        this->assert_false(this->bruteforceEquals(queue1, queue3),
 ...
 * @tparam PrioQueueT Type of the priority queue.
 */
template <class PrioQueueT> class GeneralPrioQueueTest : public CompositeTest {
  public:
...
class TwoListsTest : public CompositeTest {
  public:
    TwoListsTest() : CompositeTest("TwoLists") {
        this->add_test(std::make_unique<GeneralPrioQueueTest<adt::TwoLists<int, int>>>(
  ...
  public:
    PriorityQueueTest() : CompositeTest("PriorityQueue") {
        this->add_test(std::make_unique<
                       GeneralPrioQueueTest<adt::UnsortedImplicitSequencePriorityQueue<int, int>>>(
            "UnsortedImplicit"));
        this->add_test(std::make_unique<
                       GeneralPrioQueueTest<adt::UnsortedExplicitSequencePriorityQueue<int, int>>>(
            "UnsortedExplicit"));
        this->add_test(std::make_unique<
                       GeneralPrioQueueTest<adt::SortedImplicitSequencePriorityQueue<int, int>>>(
            "SortedImplicit"));
        this->add_test(std::make_unique<
                       GeneralPrioQueueTest<adt::SortedExplicitSequencePriorityQueue<int, int>>>(
            "SortedExplicit"));
        this->add_test(
            std::make_unique<GeneralPrioQueueTest<adt::BinaryHeap<int, int>>>("BinaryHeap"));
