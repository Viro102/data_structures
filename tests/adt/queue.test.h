 ...
 */
template <class QueueT> class QueueTestPushPeek : public LeafTest {
  public:
  ...
  protected:
    void test() override {
        ...
        this->assert_throws([&queue]() { queue.peek(); }, "Empty queue throws on peek");
 ...
 * @tparam QueueT Type of the queue.
 */
template <class QueueT> class QueueTestPop : public LeafTest {
  public:
  ...
  protected:
    void test() override {
        ...
        this->assert_throws([&queue]() { queue.pop(); }, "Empty queue throws on pop");
 ...
 * @tparam QueueT Type of the queue.
 */
template <class QueueT> class QueueTestClear : public LeafTest {
  public:
 ...
 * @tparam QueueT Type of the queue.
 */
template <class QueueT> class QueueTestCopyAssignEquals : public LeafTest {
  public:
  ...
  protected:
    void test() override {
        ...
        if constexpr (std::is_same_v<QueueT, adt::ImplicitQueue<int>>) {
            ...
            queue4.push(1);
            queue5.push(2);
            this->assert_false(queue4.equals(queue5),
 ...
 * @tparam QueueT Type of the queue.
 */
template <class QueueT> class GeneralQueueTest : public CompositeTest {
  public:
...
class QueueTest : public CompositeTest {
  public:
    QueueTest() : CompositeTest("Queue") {
        this->add_test(
            std::make_unique<GeneralQueueTest<adt::ImplicitQueue<int>>>("ImplicitQueue"));
        this->add_test(
            std::make_unique<GeneralQueueTest<adt::ExplicitQueue<int>>>("ExplicitQueue"));
    }
};
} // namespace ds::tests
