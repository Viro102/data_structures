...
class MemoryManagerTestAllocate : public LeafTest {
  public:
    MemoryManagerTestAllocate() : LeafTest("allocate") {}
...
class MemoryManagerTestRelease : public LeafTest {
  public:
    MemoryManagerTestRelease() : LeafTest("release") {}
...
class MemoryManagerTestCounts : public LeafTest {
  public:
    MemoryManagerTestCounts() : LeafTest("count") {}
...
class MemoryManagerTest : public CompositeTest {
  public:
    explicit MemoryManagerTest() : CompositeTest("MemoryManager") {
