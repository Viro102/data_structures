...
#include <libs/mm/compact_memory_manager.h>
#include <memory>
...
class CompactMemoryManagerTestGetters : public LeafTest {
  public:
    CompactMemoryManagerTestGetters() : LeafTest("getters") {}
...
class CompactMemoryManagerTestAllocate : public LeafTest {
  public:
    CompactMemoryManagerTestAllocate() : LeafTest("allocate") {}
...
class CompactMemoryManagerTestAllocateAt : public LeafTest {
  public:
    CompactMemoryManagerTestAllocateAt() : LeafTest("allocateAt") {}
...
class CompactMemoryManagerTestRelease : public LeafTest {
  public:
    CompactMemoryManagerTestRelease() : LeafTest("release") {}
  ...
  protected:
    void test() override {
        ...
        this->assert_equals(static_cast<std::size_t>(n) - 1, manager.getAllocatedBlockCount());
    }
};
...
class CompactMemoryManagerTestReleaseAt : public LeafTest {
  public:
    CompactMemoryManagerTestReleaseAt() : LeafTest("releaseAt") {}
  ...
  protected:
    void test() override {
        ...
        this->assert_equals(static_cast<std::size_t>(n) - 3, manager.getAllocatedBlockCount());
    }
};
...
class CompactMemoryManagerTestReleasePtr : public LeafTest {
  public:
    CompactMemoryManagerTestReleasePtr() : LeafTest("releasePtr") {}
...
class CompactMemoryManagerTestAssign : public LeafTest {
  public:
    CompactMemoryManagerTestAssign() : LeafTest("assign") {}
  ...
  protected:
    void test() override {
        ...
        for (int i = 0; i < n; ++i) {
            this->assert_equals(manager1.getBlockAt(i).get_number(),
...
class CompactMemoryManagerTestEquals : public LeafTest {
  public:
    CompactMemoryManagerTestEquals() : LeafTest("equals") {}
...
class CompactMemoryManagerTestCalculateAddress : public LeafTest {
  public:
    CompactMemoryManagerTestCalculateAddress() : LeafTest("calculateAddress") {}
...
class CompactMemoryManagerTestCalculateIndex : public LeafTest {
  public:
    CompactMemoryManagerTestCalculateIndex() : LeafTest("calculateIndex") {}
...
class CompactMemoryManagerSwap : public LeafTest {
  public:
    CompactMemoryManagerSwap() : LeafTest("swap") {}
...
class CompactMemoryManagerTest : public CompositeTest {
  public:
    CompactMemoryManagerTest() : CompositeTest("CompactMemoryManager") {
