...
class MWEHTestInsert : public LeafTest {
  public:
    MWEHTestInsert() : LeafTest("insert") {}
...
class MWEHTestAccess : public LeafTest {
  public:
    MWEHTestAccess() : LeafTest("access") {}
...
class MWEHTestLevelsCountsDegs : public LeafTest {
  public:
    MWEHTestLevelsCountsDegs() : LeafTest("level-count-degree") {}
...
class MWEHTestRemove : public LeafTest {
  public:
    MWEHTestRemove() : LeafTest("remove") {}
...
class MWEHTestCopyAssignEquals : public LeafTest {
  public:
    MWEHTestCopyAssignEquals() : LeafTest("copy-assign-equals") {}
...
class MultiwayExplicitHierarchyTest : public CompositeTest {
  public:
    MultiwayExplicitHierarchyTest() : CompositeTest("MultiwayExplicitHierarchy") {
...
class KWEHTestInsert : public LeafTest {
  public:
    KWEHTestInsert() : LeafTest("insert") {}
...
class KWEHTestAccess : public LeafTest {
  public:
    KWEHTestAccess() : LeafTest("access") {}
...
class KWEHTestLevelCountDeg : public LeafTest {
  public:
    KWEHTestLevelCountDeg() : LeafTest("level-count-degree") {}
...
class KWEHTestRemove : public LeafTest {
  public:
    KWEHTestRemove() : LeafTest("remove") {}
...
class KWEHTestCopyAssignEquals : public LeafTest {
  public:
    KWEHTestCopyAssignEquals() : LeafTest("copy-assign-equals") {}
...
class KWayExplicitHierarchyTest : public CompositeTest {
  public:
    KWayExplicitHierarchyTest() : CompositeTest("KWayExplicitHierarchy") {
...
class ExplicitHierarchyTest : public CompositeTest {
  public:
    ExplicitHierarchyTest() : CompositeTest("ExplicitHierarchy") {
