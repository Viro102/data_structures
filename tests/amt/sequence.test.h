 ...
 */
template <class SequenceT> class SequenceTestCalculateIndex : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestInsertEnds : public LeafTest {
  public:
    SequenceTestInsertEnds() : LeafTest("insertEnds") {}
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestInsertRandom : public LeafTest {
  public:
    SequenceTestInsertRandom() : LeafTest("insertRandom") {}
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestInsertBefore : public LeafTest {
  public:
    SequenceTestInsertBefore() : LeafTest("insertBefore") {}
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestInsertAfter : public LeafTest {
  public:
    SequenceTestInsertAfter() : LeafTest("insertAfter") {}
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestAccessEnds : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestAccessRandom : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestAccessPrevNext : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestRemoveEnds : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestRemoveRandom : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestRemoveNext : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestRemovePrevious : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestProcessForward : public LeafTest {
  public:
  ...
  protected:
    void test() override {
        ...
        int processed = 0;
        seq.processBlocksForward(seq.accessFirst(),
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestProcessBackward : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestFindWithProperty : public LeafTest {
  public:
  ...
  protected:
    void test() override {
        ...
        amt::MemoryBlock<int> *found = seq.findBlockWithProperty(
            [=](const amt::MemoryBlock<int> *block) { return block->data_ == intToFind; });
        this->assert_not_null(found);
        this->assert_equals(intToFind, found->data_);

        amt::MemoryBlock<int> *notFound =
            seq.findBlockWithProperty([](amt::MemoryBlock<int> *) { return false; });
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestFindPrevToWithProperty : public LeafTest {
  public:
    SequenceTestFindPrevToWithProperty() : LeafTest("findPrevToBlockWithProperty") {}
  ...
  protected:
    void test() override {
        ...
        this->assert_null(
            seq.findPreviousToBlockWithProperty([](amt::MemoryBlock<int> *) { return false; }));
        this->assert_null(seq.findPreviousToBlockWithProperty(
            [](const amt::MemoryBlock<int> *block) { return block->data_ == 0; }));
    }
};
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestIterators : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestClear : public LeafTest {
  public:
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class SequenceTestCopyAssignEquals : public LeafTest {
  public:
    SequenceTestCopyAssignEquals() : LeafTest("copy-assign-equals") {}
 ...
 * @tparam SequenceT Type of the sequence. Either explicit or implicit.
 */
template <class SequenceT> class GenericSequenceTest : public CompositeTest {
  public:
    GenericSequenceTest() : CompositeTest("GenericSequenceTest") {
