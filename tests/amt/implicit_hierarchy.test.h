...
namespace ds::tests {
namespace details {
template <std::size_t K> amt::ImplicitHierarchy<int, K> makeIH(const int n) {
...
class ImplicitHierarchyTestThrowing : public LeafTest {
  public:
    ImplicitHierarchyTestThrowing() : LeafTest("unsupported-methods") {}
  ...
  protected:
    auto test() -> void override {
        ...
        this->assert_throws([&hierarchy]() { hierarchy.emplaceSon(*hierarchy.accessRoot(), 0); });

        this->assert_throws(
            [&hierarchy]() { hierarchy.changeSon(*hierarchy.accessRoot(), 0, nullptr); });

        this->assert_throws([&hierarchy]() { hierarchy.removeSon(*hierarchy.accessRoot(), 0); });
    }
};
...
class ImplicitHierarchyTestInsert : public LeafTest {
  public:
    ImplicitHierarchyTestInsert() : LeafTest("insertLastLeaf") {}
...
class ImplicitHierarchyTestAccess : public LeafTest {
  public:
    ImplicitHierarchyTestAccess() : LeafTest("access") {}
...
class ImplicitHierarchyTestLevelsCountsDegs : public LeafTest {
  public:
    ImplicitHierarchyTestLevelsCountsDegs() : LeafTest("level-count-degree") {}
  ...
  protected:
    void test() override {
        ...
        this->assert_equals(static_cast<size_t>(3),
                            hierarchy.nodeCount(*hierarchy.accessSon(*hierarchy.accessRoot(), 1)));
...
class ImplicitHierarchyTestRemove : public LeafTest {
  public:
    ImplicitHierarchyTestRemove() : LeafTest("removeLastLeaf") {}
...
class ImplicitHierarchyTestCopyAssign : public LeafTest {
  public:
    ImplicitHierarchyTestCopyAssign() : LeafTest("copy/assign") {}
  ...
  protected:
    void test() override {
        ...
        hierarchy1.removeLastLeaf();
        hierarchy1.removeLastLeaf();
        this->assert_false(hierarchy1.equals(hierarchy3),
...
class ImplicitHierarchyTest : public CompositeTest {
  public:
    ImplicitHierarchyTest() : CompositeTest("ImplicitHierarchy") {
