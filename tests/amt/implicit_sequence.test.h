...
class ImplicitSequenceTestIndexOfRelative : public LeafTest {
  public:
    ImplicitSequenceTestIndexOfRelative() : LeafTest("indexOfNext/Prev") {}
...
class CyclicImplicitSequenceTestIndexOfRelative : public LeafTest {
  public:
    CyclicImplicitSequenceTestIndexOfRelative() : LeafTest("cyclic indexOfNext/Prev") {}
...
class ImplicitSequenceTest : public CompositeTest {
  public:
    ImplicitSequenceTest() : CompositeTest("ImplicitSequence") {
