...
#include <libs/amt/explicit_hierarchy.h>
...
namespace ds::tests {
namespace details {
template <class Hierarchy> struct HierarchyFixture {
...
inline auto const makeKWEH = []() -> HierarchyFixture<amt::KWayExplicitHierarchy<int, 3>> {
    ...
    return {std::move(hierarchy), {0, 1, 3, 4, 2, 5}, {3, 4, 1, 5, 2, 0}, {0, 1, 2, 3, 4, 5}, {}};
};
 ...
 */
template <class MakeFixtureType> class HierarchyTestProcessPreOrder : public LeafTest {
  public:
    HierarchyTestProcessPreOrder(MakeFixtureType makeFixture, const std::string &name)
        : LeafTest(name), makeFixture_(std::move(makeFixture)) {}
 ...
 */
template <class MakeFixtureType> class HierarchyTestProcessPostOrder : public LeafTest {
  public:
 ...
 */
template <class MakeFixtureType> class HierarchyTestProcessLevelOrder : public LeafTest {
  public:
 ...
 */
template <class MakeFixtureType> class HierarchyTestPreOrderIterator : public LeafTest {
  public:
 ...
 */
template <class MakeFixtureType> class HierarchyTestPostOrderIterator : public LeafTest {
  public:
 ...
 */
template <class MakeFixtureType> class BinaryHierarchyTestProcessInOrder : public LeafTest {
  public:
 ...
 *  @brief Tests post-order iterator.
 */
template <class MakeFixture> class BinaryHierarchyTestInOrderIterator : public LeafTest {
  public:
    BinaryHierarchyTestInOrderIterator(MakeFixture makeFixture, const std::string &name)
        : LeafTest(name), makeFixture_(makeFixture) {}
...
class HierarchyTest : public CompositeTest {
  public:
    HierarchyTest() : CompositeTest("Hierarchy") {
        ...
        this->add_test(std::make_unique<HierarchyTestProcessPreOrder<MakeKWEHType>>(
            details::makeKWEH, "process-pre-order-kweh"));
        this->add_test(std::make_unique<HierarchyTestProcessPreOrder<MakeMWEHType>>(
            details::makeMWEH, "process-pre-order-mweh"));
        this->add_test(std::make_unique<HierarchyTestProcessPreOrder<MakeBIHType>>(
            details::makeBIH, "process-pre-order-bih"));
        this->add_test(std::make_unique<HierarchyTestProcessPostOrder<MakeKWEHType>>(
            details::makeKWEH, "process-post-order-kweh"));
        this->add_test(std::make_unique<HierarchyTestProcessPostOrder<MakeMWEHType>>(
            details::makeMWEH, "process-post-order-mweh"));
        this->add_test(std::make_unique<HierarchyTestProcessPostOrder<MakeBIHType>>(
            details::makeBIH, "process-post-order-bih"));
        this->add_test(std::make_unique<HierarchyTestProcessLevelOrder<MakeKWEHType>>(
            details::makeKWEH, "process-level-order-kweh"));
        this->add_test(std::make_unique<HierarchyTestProcessLevelOrder<MakeMWEHType>>(
            details::makeMWEH, "process-level-order-mweh"));
        this->add_test(std::make_unique<HierarchyTestProcessLevelOrder<MakeBIHType>>(
            details::makeBIH, "process-level-order-bih"));
        this->add_test(std::make_unique<HierarchyTestPreOrderIterator<MakeKWEHType>>(
            details::makeKWEH, "pre-order-iterator-kweh"));
        this->add_test(std::make_unique<HierarchyTestPreOrderIterator<MakeMWEHType>>(
            details::makeMWEH, "pre-order-iterator-mweh"));
        this->add_test(std::make_unique<HierarchyTestPreOrderIterator<MakeBIHType>>(
            details::makeBIH, "pre-order-iterator-bih"));
        this->add_test(std::make_unique<HierarchyTestPostOrderIterator<MakeKWEHType>>(
            details::makeKWEH, "post-order-iterator-kweh"));
        this->add_test(std::make_unique<HierarchyTestPostOrderIterator<MakeMWEHType>>(
            details::makeMWEH, "post-order-iterator-mweh"));
        this->add_test(std::make_unique<HierarchyTestPostOrderIterator<MakeBIHType>>(
            details::makeBIH, "post-order-iterator-bih"));
        this->add_test(std::make_unique<BinaryHierarchyTestProcessInOrder<MakeBIHType>>(
            details::makeBIH, "process-in-order-bih"));
        this->add_test(std::make_unique<BinaryHierarchyTestProcessInOrder<MakeBEHType>>(
            details::makeBEH, "process-in-order-beh"));
        this->add_test(std::make_unique<BinaryHierarchyTestInOrderIterator<MakeBIHType>>(
            details::makeBIH, "in-order-iterator-bih"));
        this->add_test(std::make_unique<BinaryHierarchyTestInOrderIterator<MakeBEHType>>(
            details::makeBEH, "in-order-iterator-beh"));
    }
};
} // namespace ds::tests
