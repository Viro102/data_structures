...
namespace ds::adt {
template <typename T> class Tree : virtual public ADT {
  public:
...
template <typename T> class MultiwayTree : public GeneralTree<T, amt::MultiWayEH<T>> {};
...
template <typename T> class ExplicitBinaryTree : public GeneralTree<T, amt::BinaryEH<T>> {};
...
template <typename T, typename HierarchyType>
typename GeneralTree<T, HierarchyType>::Node *
GeneralTree<T, HierarchyType>::accessParent(const Node &node) const {
    return this->getHierarchy()->accessParent(this->getNode(node));
}

template <typename T, typename HierarchyType>
typename GeneralTree<T, HierarchyType>::Node *
GeneralTree<T, HierarchyType>::accessSon(const Node &node, size_t sonOrder) const {
    typename HierarchyType::BlockType *son =
        this->getHierarchy()->accessSon(this->getNode(node), sonOrder);
    if (son == nullptr) {
...
template <typename T, typename HierarchyType>
typename GeneralTree<T, HierarchyType>::Node &
GeneralTree<T, HierarchyType>::emplaceSon(Node &parent, size_t sonORd) {
