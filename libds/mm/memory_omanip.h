...
PtrPrint<DataType>::PtrPrint(const DataType *ptr, int base, int width) : ptr_(ptr) {
...
template <typename DataType>
PtrPrintBin<DataType>::PtrPrintBin(const DataType *ptr) : PtrPrint<DataType>(ptr, 2, 8) {}
} // namespace ds::mm
