...
namespace ds::amt {
template <typename DataType> struct ExplicitHierarchyBlock : public MemoryBlock<DataType> {
...
template <typename DataType> using MWEHBlock = MultiWayExplicitHierarchyBlock<DataType>;
...
template <typename DataType> using MultiWayEH = MultiWayExplicitHierarchy<DataType>;
...
template <typename DataType, size_t K> using KWEHBlock = KWayExplicitHierarchyBlock<DataType, K>;

template <typename DataType, size_t K>
class KWayExplicitHierarchy : public KWayHierarchy<KWayExplicitHierarchyBlock<DataType, K>, K>,
...
template <typename DataType, size_t K> using KWayEH = KWayExplicitHierarchy<DataType, K>;
...
template <typename DataType> using BEHBlock = BinaryExplicitHierarchyBlock<DataType>;

template <typename DataType>
class BinaryExplicitHierarchy : public BinaryHierarchy<BinaryExplicitHierarchyBlock<DataType>>,
...
template <typename BlockType> ExplicitHierarchy<BlockType>::ExplicitHierarchy() : root_(nullptr) {}
...
template <typename BlockType> AMT &ExplicitHierarchy<BlockType>::assign(const AMT &other) {
...
template <typename BlockType> size_t ExplicitHierarchy<BlockType>::size() const {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
}

template <typename BlockType> bool ExplicitHierarchy<BlockType>::isEmpty() const {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
}

template <typename BlockType> bool ExplicitHierarchy<BlockType>::equals(const AMT &other) {
    const ExplicitHierarchy<BlockType> *otherHierarchy =
        dynamic_cast<const ExplicitHierarchy<BlockType> *>(&other);
...
template <typename BlockType> BlockType *ExplicitHierarchy<BlockType>::accessRoot() const {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
}
...
template <typename BlockType> BlockType &ExplicitHierarchy<BlockType>::emplaceRoot() {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
}

template <typename BlockType> void ExplicitHierarchy<BlockType>::changeRoot(BlockType *newRoot) {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
}
...
template <typename DataType> MultiWayExplicitHierarchy<DataType>::~MultiWayExplicitHierarchy() {
    // TODO 07
}
...
template <typename DataType>
auto MultiWayExplicitHierarchy<DataType>::accessSon(const BlockType &node, size_t sonOrder) const
    -> BlockType * {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
...
template <typename DataType>
auto MultiWayExplicitHierarchy<DataType>::emplaceSon(BlockType &parent, size_t sonOrder)
    -> BlockType & {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
...
template <typename DataType>
void MultiWayExplicitHierarchy<DataType>::changeSon(BlockType &parent, size_t sonOrder,
                                                    BlockType *newSon) {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
...
template <typename DataType, size_t K>
auto KWayExplicitHierarchy<DataType, K>::accessSon(const BlockType &node, size_t sonOrder) const
    -> BlockType * {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
...
template <typename DataType, size_t K>
auto KWayExplicitHierarchy<DataType, K>::emplaceSon(BlockType &parent, size_t sonOrder)
    -> BlockType & {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
...
template <typename DataType, size_t K>
void KWayExplicitHierarchy<DataType, K>::changeSon(BlockType &parent, size_t sonOrder,
                                                   BlockType *newSon) {
    // TODO 07
    // po implementacii vymazte vyhodenie vynimky!
    throw std::runtime_error("Not implemented yet");
...
template <typename DataType> BinaryExplicitHierarchy<DataType>::~BinaryExplicitHierarchy() {
    // TODO 07
}
...
template <typename DataType>
auto BinaryExplicitHierarchy<DataType>::accessSon(const BlockType &node, size_t sonOrder) const
    -> BlockType * {
    switch (sonOrder) {
...
template <typename DataType>
auto BinaryExplicitHierarchy<DataType>::emplaceSon(BlockType &parent, size_t sonOrder)
    -> BlockType & {
...
template <typename DataType>
void BinaryExplicitHierarchy<DataType>::changeSon(BlockType &parent, size_t sonOrder,
                                                  BlockType *newSon) {
    if (sonOrder == BinaryHierarchy<BlockType>::LEFT_SON_INDEX) {
